...
const serviceEnv = {
  ...
  OPEN_SPANNER_ALERT_WORKER_MAX_ATTEMPTS: "1",
  OPEN_SPANNER_ALERT_WORKER_RETRY_AFTER: "100ms",
  ...
  OPEN_SPANNER_USAGE_WORKER_HEALTH_ADDR: "127.0.0.1:19285",
  OPEN_SPANNER_USAGE_WORKER_INTERVAL: "250ms",
  OPEN_SPANNER_USAGE_WORKER_RETRY_AFTER: "100ms",
  ...
  OPEN_SPANNER_RETENTION_PRUNE_INTERVAL: "20s",
  OPEN_SPANNER_RETENTION_PRUNE_TIMEOUT: "10s",
};
...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: "go run ./cmd/usage-worker",
      cwd: "..",
      env: serviceEnv,
      reuseExistingServer: false,
      timeout: 120_000,
      url: "http://127.0.0.1:19285/ready",
    },
    {
