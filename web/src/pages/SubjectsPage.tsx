...
import { ArrowLeft, ArrowRight, BarChart3, Clock, Database, Download, Eye, Hash, Loader2, Search, Users } from 'lucide-react'
...
function SubjectDetailPage({ routeSubject }: { routeSubject: string }) {
  const router = useRouter()
  const {
    detailStatus,
  ...
  const subjectName = selectedSubject || selectedRouteSubject
