...
const schemaNames = new Map([
  ...
  ["internal_metering_adapters_http_usage.ConsumeRequest", "EntitlementConsumeRequest"],
  ["internal_metering_adapters_http_usage.ConsumeResponse", "EntitlementConsumeResponse"],
  ["internal_metering_adapters_http_usage.ConsumeQuotaResponse", "EntitlementConsumeQuota"],
  ["internal_metering_adapters_http_usage.ConsumptionDecisionResponse", "ConsumptionDecision"],
  ["internal_metering_adapters_http_usage.ConsumptionDecisionListResponse", "ConsumptionDecisionListResponse"],
...
const sdkOperations = new Map([
  ...
  ["/v1/entitlements/consume", new Set(["post"])],
  ["/v1/entitlements/decisions", new Set(["get"])],
  ["/v1/entitlements/decisions/{idempotency_key}", new Set(["get"])],
