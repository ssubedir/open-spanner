...
SDKs intentionally expose a narrower surface than the full REST API. Auth
management, dashboard sessions, system stats, raw-event operator endpoints, and
pruning endpoints are not part of the SDKs.
