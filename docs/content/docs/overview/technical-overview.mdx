...
Meters and plans are configuration records. Usage events are immutable facts with idempotency keys. Usage queries and entitlement checks aggregate retained events at request time using SQL.
