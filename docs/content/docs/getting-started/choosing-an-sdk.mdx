...
All four SDKs support the REST API and gRPC usage ingestion. Choose REST for
configuration, queries, exports, and entitlements. Choose gRPC single, bulk, or
client-streaming writes for sustained backend ingestion.
