...
See [`examples/advance/historical-backfill`](https://github.com/ssubedir/open-spanner/tree/main/examples/advance/historical-backfill) for Go, TypeScript, Python, and C# examples.
