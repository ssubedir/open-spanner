...
See [`examples/rest/advance/active-users`](https://github.com/ssubedir/open-spanner/tree/main/examples/rest/advance/active-users) for Go, TypeScript, Python, and C# examples.
