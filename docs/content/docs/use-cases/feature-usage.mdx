...
See [`examples/rest/advance/feature-usage`](https://github.com/ssubedir/open-spanner/tree/main/examples/rest/advance/feature-usage) for Go, TypeScript, Python, and C# examples.
