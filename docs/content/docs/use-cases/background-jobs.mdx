...
See [`examples/advance/background-jobs`](https://github.com/ssubedir/open-spanner/tree/main/examples/advance/background-jobs) for Go, TypeScript, Python, and C# examples.
