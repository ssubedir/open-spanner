...
See [`examples/rest/advance/ai-tokens`](https://github.com/ssubedir/open-spanner/tree/main/examples/rest/advance/ai-tokens) for Go, TypeScript, Python, and C# examples.
