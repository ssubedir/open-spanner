...
See [`examples/rest/advance/storage-usage`](https://github.com/ssubedir/open-spanner/tree/main/examples/rest/advance/storage-usage) for Go, TypeScript, Python, and C# examples.
