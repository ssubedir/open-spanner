...
Raw events can be pruned by meter retention policy. Hourly rollups preserve aggregate reporting and dimensions after pruning, while individual event browsing remains limited to the raw-event window.
