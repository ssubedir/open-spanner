...
```sh
curl "http://localhost:18081/v1/usages/dimensions?meter=api_requests&field=region&subject=org_123&from=2026-06-01T00:00:00Z&to=2026-06-10T00:00:00Z" \
...
```sh
curl "http://localhost:18081/v1/usages?subject=org_123&meter=api_requests&from=2026-06-01T00:00:00Z&to=2026-06-10T00:00:00Z&bucket_size=day&metadata.region=us-east" \
...
```sh
curl "http://localhost:18081/v1/usages?subject=org_123&meter=api_requests&from=2026-06-01T00:00:00Z&to=2026-06-10T00:00:00Z&bucket_size=day&group_by=region&group_by=plan" \
  -H "Authorization: Bearer $OPEN_SPANNER_API_KEY"
```
