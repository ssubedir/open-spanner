...
T = TypeVar("T", bound="UsageBreakdownRequest")


@_attrs_define
class UsageBreakdownRequest:
    """
    Attributes:
        field (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        usage_breakdown_request.additional_properties = d
        return usage_breakdown_request
