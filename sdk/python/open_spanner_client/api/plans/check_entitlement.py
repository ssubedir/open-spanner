...
from ...models.entitlement_check_request import EntitlementCheckRequest
...
) -> EntitlementCheckResponse | ErrorResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EntitlementCheckResponse | ErrorResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        EntitlementCheckResponse | ErrorResponse
    """
